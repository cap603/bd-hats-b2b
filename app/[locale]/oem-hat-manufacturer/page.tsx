...
const CONTENT = {
  en: {
    hero: {
      ...
      h1Post: " in China",
      subtitle: "From sketch to shipped — a full-service factory behind 300+ brands in 50+ countries since 2014. SGS verified, 100% QC, samples in 7 days.",
    ...
    capabilities: [
      ...
      { title: "Certifications & Compliance", desc: "SGS factory verification, CE product certification, and full REACH and RoHS compliance for the European market. Our quality system follows a 5-stage 100% inspection protocol on every order." },
  ...
  es: {
    hero: {
      ...
      h1Post: " en China",
      subtitle: "Del boceto al envío — una fábrica integral detrás de más de 300 marcas en más de 50 países desde 2014. Verificados por SGS, QC 100%, muestras en 7 días.",
    ...
    capabilities: [
      ...
      { title: "Certificaciones y cumplimiento", desc: "Verificación de fábrica por SGS, certificación de producto CE y pleno cumplimiento de REACH y RoHS para el mercado europeo. Nuestro sistema de calidad sigue un protocolo de inspección 100% de 5 etapas en cada pedido." },
...
export default function OemPage() {
  ...
  const articleSchema = {
    ...
    "description": "Full-service OEM/ODM hat manufacturer: 50,000sqm factory, 100+ embroidery machines, SGS/CE/REACH certified, 100% QC, samples in 7 days. Serving 300+ brands worldwide.",
