...
const CONTENT = {
  en: {
    hero: {
      ...
      pills: ["5M+ Caps / Year", "100+ Machines", "AQL 2.5 QC", "FOB or CIF"],
    },
  ...
  es: {
    hero: {
      ...
      pills: ["5M+ gorras al año", "Más de 100 máquinas", "Control AQL 2.5", "FOB o CIF"],
    },
...
export default function BulkHatsPage() {
  ...
  const articleSchema = {
    ...
    description:
      "Large-volume custom hat production: 5M+ caps per year, 100+ embroidery machines, volume tier pricing from 500 to 10,000+ pcs, AQL 2.5 QC, FOB or CIF.",
